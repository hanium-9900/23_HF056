  ...
  return (
    <main className="max-w-7xl mx-auto py-14 px-4">
      ...
      <div className="flex items-center justify-center gap-5 mb-8">
        ...
        <button className="rounded-full border-2 border-slate-400 bg-white text-slate-400 font-bold transition-colors hover:border-slate-500 hover:text-slate-500 text-xl py-3 px-10">
          카테고리1
        </button>
      </div>
      ...
      <div className="grid grid-cols-3 gap-5">
        {services.map((service, idx) => (
          ...
          >
            <div className="mb-6">
              <div className="inline-block rounded-full bg-blue-500 text-white text-xs font-bold py-1 px-4 mb-3">{service.category || '카테고리 없음'}</div>
